...
#define AP_SERIALMANAGER_RPI_BAUD           115200 // still have to decide on these 3 numbers
#define AP_SERIALMANAGER_RPI_BUFSIZE_RX     256
#define AP_SERIALMANAGER_RPI_BUFSIZE_TX     128
