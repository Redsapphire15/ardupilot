...
#define DEFAULT_SERIAL5_PROTOCOL SerialProtocol_RPI
#endif
#ifndef DEFAULT_SERIAL5_BAUD
	// #define DEFAULT_SERIAL5_BAUD AP_SERIALMANAGER_MAVLINK_BAUD/1000
#define DEFAULT_SERIAL5_BAUD AP_SERIALMANAGER_RPI_BAUD/1000
#endif
        ...
        if (uart != nullptr) {
            ...
            switch (state[i].protocol) {
                ...
                case SerialProtocol_GPS2:
                    ...
                    break;
                case SerialProtocol_RPI:
                    uart->begin(state[i].baudrate(),
                         AP_SERIALMANAGER_RPI_BUFSIZE_RX,
                         AP_SERIALMANAGER_RPI_BUFSIZE_TX);
                    break;
